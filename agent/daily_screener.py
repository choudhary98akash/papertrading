...
Plotly.newPlot('chart', [{{
  ...
  yaxis:{{showgrid:true, gridcolor:'#1e293b', tickprefix:'\u20b9', tickfont:{{size:10}}, range:[{ylo}, {yhi}]}},
  shapes:[
  ...
  annotations:[
    ...
    {{x:n-1, y:{closes[-1]}, xref:'x', yref:'y', text:'Close \u20b9{closes[-1]:.2f}', showarrow:false, xanchor:'right', yanchor:'bottom', font:{{color:'#e2e8f0', size:10}}}}
  ],
